...
exports.SendMail = async (to, subject, data, type) => {
    ...
    // Type - 3 for 2fa mail
    // Type - 4 for change email mail
    // Type - 5 for forgot password mail
    // Type - 6 for reset password success mail
    // Type - 7 for change email success mail
    ...
    if (type === 6) message = ResetPasswordSuccessMailTemplate(data);

    if (type === 7) message = ChangeEmailSuccessMailTemplate(data);
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td bgcolor="#fff" style="padding: 0 33px 18px 33px; color: #000; ">
                                <p style="font-size:20px; line-height: 28px; margin: 0;">
                                  To complete account setup and start chatting on Vibe Chats platform please confirm your e-mail address by entering the verification code.
                                </p>
                            </td>
                        </tr>
                        <tr>
              ...
              <table border="0" bgcolor="#566DCB" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                          ...
                          <tr>
                              <td bgcolor="#fff" style="padding: 16px 33px 12px 33px; color: #200E32;">
                                  <p style="font-size:20px; line-height: 28px; margin: 0;">Thank you, <br>Vibe Chats</p>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 0px 33px 16px 33px; color: #200E32;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                          <tr>
                              <td bgcolor="#fff"
                                  style="padding: 18px 33px 16px 33px; font-size: 20px; line-height: 28px;color: #11181d; text-align: center;">
                                  <h3 style="margin: 0; ">Password Changed For Vibe Chats Account</h3>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 0 33px 8px 33px; color: #000; ">
                                  ...
                                  <p style="font-size:20px; line-height: 28px; margin: 0;">
                                    	You have successfully changed your Vibe Chats account password. If you did not make this request, please <a href="https://vibe-chats.vercel.app" target="_blank">reset the password</a> of your Vibe Chats account.
                                  </p>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 8px 33px 12px 33px; color: #200E32;">
                                  <p style="font-size:20px; line-height: 28px; margin: 0;">Thank you, <br>Vibe Chats</p>
                              </td>
                          </tr>
                          <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                          <tr>
                              <td bgcolor="#fff"
                                  style="padding: 18px 33px 8px 33px; font-size: 20px; line-height: 28px;color: #11181d; text-align: center;">
                                  <h3 style="margin: 0; ">Email Changed For Vibe Chats Account</h3>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 0 33px 8px 33px; color: #000; ">
                                  ...
                                  <p style="font-size:20px; line-height: 28px; margin: 0;">
                                    We wanted to let you know that the email address on your Vibe Chats account has changed recently. 
                                    <a href="https://vibe-chats.vercel.app" target="_blank">Vibe Chats</a>.
                                  </p>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 0 33px 8px 33px; color: #000; ">
                                  <p style="font-size:18px; line-height: 28px; margin: 0;">
                                    <b>Previous email address was:</b> ${old_email}
                                    <br />
                                    <b>New email address:</b> ${new_email}
                                  </p>
                              </td>
                          </tr>
                          <tr>
                              <td bgcolor="#fff" style="padding: 0px 33px 8px 33px; color: #200E32;">
                          ...
                          <tr>
                              <td bgcolor="#fff" style="padding: 0px 33px 8px 33px; color: #200E32;">
                                  <p style="font-size:18px; margin: 0;">
                                    If this wasn't you, <a href="mailto:kushal.doshi@saturncube.com" target="_blank">email</a> us to let us know. We'll look into what's happened.
                                  </p>
                              </td>
                          </tr>
                          <tr>
