...
exports.SendMail = async (to, subject, data, type) => {
    ...
    if (type === 2) message = ForgerPasswordMailTemplate(data);
                        ...
                        <tr>
                            <td bgcolor="#fff" style="padding: 0 33px 18px 33px; color: #000; ">
                                <p style="font-size:20px; line-height: 28px; margin: 0;">You are attempting to verify your
                                    email address for Vibe Chats registration. Please copy the verification code and complete
                                    the verification.
                                </p>
                            </td>
                        </tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                          ...
                          <tr>
                              <td bgcolor="#fff" style="padding: 0 33px 18px 33px; color: #000; ">
                                  <p style="font-size:20px; line-height: 28px; margin: 0;">
                                    You are attempting to login to your Vibe Chats account. 
                                    Please copy the verification code and complete the verification. 
